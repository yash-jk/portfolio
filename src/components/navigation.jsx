    ...
    <nav className="fixed top-0 w-full bg-slate-900/90 backdrop-blur-sm z-50 px-4 md:px-8">
      <div className="flex flex-row justify-between items-center py-6">
        ...
        <div className="flex flex-row ml-4 items-center gap-4 md:gap-8 mt-4 md:mt-0">
          ...
          <a href="resume/resume.pdf" target="blank">
            <button className="border font-plex-mono tracking-widest border-cyan-300 text-cyan-300 px-3 py-2 rounded hover:bg-cyan-300/10 transition-colors">
              Resume
            </button>
          </a>
        </div>
