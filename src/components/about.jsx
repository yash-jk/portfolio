      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="text-gray-400 space-y-4 w-full text-base">
            ...
            <p>
              In my downtime, I enjoy playing cricket, watching animes, and reading mangas, which fuels my creativity and helps me maintain a balanced perspective.
            </p>
            
            <p>
              I am pursuing my Bachelors from <span className="text-cyan-300 font-plex-mono">RATM, Mathura</span> in Computer Science and Engineering(2022-2025), my current CGPA is <span className="text-cyan-300 font-plex-mono">8.35</span> out of 10.
            </p>
